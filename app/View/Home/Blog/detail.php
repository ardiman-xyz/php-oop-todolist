<h1 class="text-5xl text-center my-[20px] block">DETAIL BLOG</h1>
...
<div class="w-[700px] mx-auto my-6">
    <div class="flex justify-between items-center flex-row">
        ...
        <div class="flex flex-row items-center space-x-3">
            ...
            <div class="flex justify-center">
                <button class="border-[1.5px] focus:ring-0 rounded-xl py-1 px-3 border-gray-600 ml-4">Update</button>
            </div>
        </div>
    </div>
    ...
    <div class="mt-6">
        ...
        <div class="mt-4 flex flex-row space-x-2 items-center">
            <a href="#" class="text-slate-600 hover:underline">Like</a>
            <a href="#" class="text-slate-600 hover:underline">Comments</a>
        </div>
    </div>
</div>